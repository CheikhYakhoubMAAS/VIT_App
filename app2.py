...
class MyViT(nn.Module):
    ...
    def forward(self, images):
        ...
        n, c, _, h, w  = images.shape
        #patches = patchify(images, self.n_patches).to(self.positional_embeddings.device)
        patches = patchify(images.squeeze(0), self.n_patches).to(self.positional_embeddings.device)
...
# Interface Streamlit
st.markdown('<h1 style="color:black;">VIT Image classification model</h1>', unsafe_allow_html=True)
